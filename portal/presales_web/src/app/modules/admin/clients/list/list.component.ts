...
export class ListComponent {
  ...
  records$: Observable<any[]> = this.clients$.asObservable();
    ...
    Confirmsheet
      ...
      .subscribe((result) => {
        ...
        if (result && result == true) {
          this.deleteClientProccessor(id);
          this.loadClients();
        }
      });
  ...
  deleteClientProccessor(id: string) {
    this._clientsService
      .deleteClient(id)
      .subscribe((data) => {
