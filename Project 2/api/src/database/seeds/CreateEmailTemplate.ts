...
export class CreateEmailTemplate implements Seed {
    ...
    public async seed(factory: Factory, connection: Connection): Promise<EmailTemplate> {
        ...
        const registerData = "Dear {name},<br/><br/> <p style='margin-bottom:.5em; margin: 0 0 10px 0;text-indent: 50px'> Thank you for expressing your interest and registering with OCrafter, the faster roadway for a smarter eCommerce drive.   </p>";
        ...
        const createCustomerData = 'Dear {name},<br/><br/>   ' +
            ' We are glad to inform you that OCrafter  has added you as Customer.Here are your User Credentials for logging into the Application <br>' +
        ...
        const userData = ' <p>Dear {name}, <br />&nbsp;</p>' + '<p>We are glad to inform you that OCrafter has added you as admin User.Here are your User Credentials for logging into the Application</p>' + '<p>User ID : {username}</p>' + '<p>Password : {password}</p>'
        ...
        const oauthData = "Dear {name},<br/><br/>        <p style='margin-bottom:.5em; margin: 0 0 10px 0;text-indent: 50px'> Thankyou for showing your interest in OCrafter, your temporary password for next time login is :  {xxxxxx} or you can login through Oauth. </p>";
