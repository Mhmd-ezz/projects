...
export class OrderLogService {
    ...
    // create orderLog
    public async create(order: OrderLog): Promise<OrderLog> {
        this.log.info('Create a new orderLog ');
        return this.orderLogRepository.save(order);
    }

// find Condition
    public findOne( whereCondition: any ): Promise<OrderLog> {
    ...
    // update orderLog
    public update(id: any, order: OrderLog): Promise<OrderLog> {
        order.orderId = id;
        return this.orderLogRepository.save(order);
    }
