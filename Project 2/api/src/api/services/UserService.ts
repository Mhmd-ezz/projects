...
export class UserService {
    ...
    // user list
    public list(limit: number = 0, offset: number = 0, select: any = [], relation: any = [], whereConditions: any = [], keyword: string, count: number | boolean): Promise<User[]> | Promise<number> {
        console.log(keyword);
        const condition: any = {};
