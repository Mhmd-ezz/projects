...
namespace Etl.Processes.Common
{
    ...
    /// </summary>
    public abstract class AbstractMongoDbOperation : AbstractOperation
    {
        ...
        protected AbstractMongoDbOperation(string connectionStringName)
        {
            ...
            var connnection = connectionStringSettings.ConnectionString;
        ...
        protected AbstractMongoDbOperation(ConnectionStringSettings connectionStringSettings)
        {
