...
namespace Medcilia.Clinic.Infrastructure.Enums
{
    public class FileSystemTagsEnum : LocalizedKeyedEnumeration
    {
        ...
        public static FileSystemTagsEnum CardiologySpeciality = new FileSystemTagsEnum(80, "cardiology", "cardiology", "خ+");
        public static FileSystemTagsEnum Ticket = new FileSystemTagsEnum(90, "ticket", "ticket", "ف+");
