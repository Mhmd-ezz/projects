...
namespace Medcilia.Clinic.WebApi.Mapping
{
    ...
    public class DataPartitionLookupFromRefDbResolver : IValueResolver<DataPartition, DataPartitionModel, LookupViewModel[]>
    {
        private IUnitOfWork _uow;
        private IMemoryCache _cache;

        public DataPartitionLookupFromRefDbResolver(IUnitOfWork uow, IMemoryCache memoryCache)
        {
            _uow = uow;
            _cache = memoryCache;
        }

        public LookupViewModel[] Resolve(DataPartition source, DataPartitionModel destination, LookupViewModel[] destMember, ResolutionContext context)
        {
