...
namespace Medcilia.Clinic.WebApi.Mapping
{
    ...
    public class CardiologySurgicalHistoryLookupToRefDbResolver : IValueResolver<CardiologySurgicalHistoryModel, CardiologySurgicalHistory, List<MongoDBRef>>
    {
        private IUnitOfWork _uow;
        private CacheController cacheController;
        private readonly IUserService userService;

        public CardiologySurgicalHistoryLookupToRefDbResolver(IUnitOfWork uow, IUserService userService, CacheController cacheController)
        {
            _uow = uow;
        ...
        public List<MongoDBRef> Resolve(CardiologySurgicalHistoryModel source, CardiologySurgicalHistory destination, List<MongoDBRef> destMember, ResolutionContext context)
        {
