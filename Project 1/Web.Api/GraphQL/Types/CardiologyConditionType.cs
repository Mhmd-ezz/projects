...
{
    public class CardiologyConditionType : ObjectGraphType<CardiologyConditionModel>
    {
        public CardiologyConditionType( )
        {
            Name = "CardiologyCondition";
            ...
            Field(h => h.Activities, nullable: true,type:typeof(CardiologyActivitiesType)).Description("");

            Field(h => h.Height, nullable: true, type: typeof(FloatGraphType)).Description("");
            Field(h => h.Weight, nullable: true, type: typeof(FloatGraphType)).Description("");
            Field(h => h.Bmi, nullable: true, type: typeof(FloatGraphType)).Description("");
