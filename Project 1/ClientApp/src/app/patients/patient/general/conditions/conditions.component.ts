...
import { getApolloClient } from './../../../../blocks/graphql/graphql.service';
...
@Component({
    selector: 'general-conditions',
    templateUrl: './conditions.component.html',
    styleUrls: ['./conditions.component.scss', './carousel.component.scss']
    // changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GeneralConditionsComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    testApollo() {
        ...
        const { patient } = this.apollo.client.readQuery({ query: patientQ, variables: { id: id } });
        console.log(patient)
        ...
        if (index == -1) {
            ...
            this.apollo.client.writeQuery({ query: patientQ, variables: { id: id }, data: { patient: loadedpatient } });
        }
    }
    ...
    ngOnInit(): void {
        ...
        this._store.select(fromSelectors.medicationsByFollowup)
            ...
            .subscribe(response => {
                ...
                //   console.log('followup',this.medicationsByFollowup)     
    ...
    ShowOrHideThisCondition(id, status) {
        ...
        let conditions: any[] = cloneDeepWith(this.patient.patientInfo.specialities.general.conditions);
    ...
    ShowOrHideThisVisit(idCondition, status, id) {
        ...
        this._store.dispatch(fromActions.updateGeneralFollowup({ patientId: this.patient.id, conditionId: idCondition, replacedConditionId: undefined, followup: visit }));
     ...
     * @param {*} patient
     * @returns {*}
     * @memberof GeneralConditionsComponent
     */
    ConditionsReformat(patient: Patient): any {
        let conditions: any[] = cloneDeepWith(patient.patientInfo.specialities.general.conditions);
