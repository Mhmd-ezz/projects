import { EditGeneralMedicalHistoryDialogComponent } from './../edit-general-medical-history-dialog/edit-general-medical-history-dialog.component';
...
@Component({
    selector: 'general-medical-history',
    templateUrl: './medical-history.component.html',
    styleUrls: ['./medical-history.component.scss']
})
export class GeneralMedicalHistoryComponent implements OnInit, OnDestroy {
    ...
    */
    ngOnInit() {
        ...
        .subscribe(data => {
            ...
            this.medicalHistory = this.patient.patientInfo.specialities.general.medicalHistory ? this.patient.patientInfo.specialities.general.medicalHistory : {};
                    }         
        }       ); 
    ...
    */
    ...
    onEdit(focusOn) {
        const dialogRef = this.dialog.open(EditGeneralMedicalHistoryDialogComponent, {
            minWidth: '330px',
            data: {
                id: this.patient.id,
                focusOn: focusOn
