...
@Component({
    selector: 'new-patient-cardiology',
    templateUrl: './new-patient-cardiology.component.html',
    styleUrls: ['./new-patient-cardiology.component.scss'],
    animations: fuseAnimations
})
export class NewPatientCardiologyComponent implements OnInit {
    ...
    public dataSource = new MatTableDataSource(this.contact.patientInfo.specialities.cardiology.medicalHistory.surgicalHistory.data);
    ...
    */
    ...
    lookupNotifyHandler(eventData: outputDataEvent) {
        ...
        console.log(modelName, eventData.data);
        if (modelName) {           
            this.contact.patientInfo.specialities.cardiology.medicalHistory[eventData.modelName].data = eventData.data;
    ...
    lookupNotifyHandlerRisk(eventData: outputDataEvent) {        
        const modelName = eventData.modelName;
        if (modelName) { 
            this.contact.patientInfo.specialities.cardiology.medicalHistory.riskFactors.data = eventData.data;
            this.onPatientChange.next(this.contact);
        }
    ...
    onDone() {
        ...
        if (this.contact.id) {
            this._router.navigate(['/patients', this.contact.id, 'cardiology']);
        }
        else {
    ...
    onRemoveSurgery(index) {
        this.contact.patientInfo.specialities.cardiology.medicalHistory.surgicalHistory.data.splice(index, 1);
        this.dataSource = new MatTableDataSource(this.contact.patientInfo.specialities.cardiology.medicalHistory.surgicalHistory.data);
        this.onPatientChange.next(this.contact);
    ...
    lookupNotifyHandlerOperation(eventData: outputDataEvent) {        
        const modelName = eventData.modelName; 
         if (modelName)  {              
           // this.surgery.what.push(eventData.data);
    ...
    onAddSurgery() {
        ...
        this.contact.patientInfo.specialities.cardiology.medicalHistory.surgicalHistory.data.push(this.surgery);  
        this.dataSource = new MatTableDataSource(this.contact.patientInfo.specialities.cardiology.medicalHistory.surgicalHistory.data);
    ...
    notifySurgeryHandler(eventData: outputDataEvent) {
        ...
        if (surgery){
            this.contact.patientInfo.specialities.cardiology.medicalHistory.surgicalHistory.data = eventData.data;
            this.onPatientChange.next(this.contact);
        }
    ...
    private sendXhrProcessor() {
        ...
        if (this.contact.id) {          
            ...
            console.log('final contact', patient);
    ...
    private onCreateContactCallback(response) {
        ...
        const patientMedicalHistory = this.contact.patientInfo.specialities.cardiology.medicalHistory;
        ...
        patientMedicalHistory.pastMedication.data = uniqBy(
            ...
            .concat((response as PatientBase).patientInfo.specialities.cardiology.medicalHistory.pastMedication.data),
        ...
        patientMedicalHistory.presentMedication.data = uniqBy(
            patientMedicalHistory.presentMedication.data
                .concat((response as PatientBase).patientInfo.specialities.cardiology.medicalHistory.presentMedication.data),
                (obj: any) => (obj.drug.name as string).toLowerCase());
                // 'drug.name');

        this.contact = AppUtils.mergeForForms(this.contact, response);        
        this.contact.patientInfo.specialities.cardiology.medicalHistory = patientMedicalHistory;
